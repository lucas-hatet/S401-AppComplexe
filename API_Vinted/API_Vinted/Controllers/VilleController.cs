...
namespace API_Vinted.Controllers
{
    ...
    {
        private readonly VilleManager _repository;

        public VilleController(VilleManager repository)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> AddAsync([FromBody] Ville entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> UpdateAsync(int id, [FromBody] Ville entity)
        {
